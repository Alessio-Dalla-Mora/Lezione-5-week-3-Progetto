...
const onlyLetters = function (){
  let text = 'I have 4 dogs'
  let result = text.substring(0,6)
  let result2 = text.substring(8,13)
...
const isTodayMyBirthday = function(){
  let birthday = 18/06/2000
if( birthday === whatDayIsIt){console.log('è il tuo compleanno')}
